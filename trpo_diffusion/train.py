"""Main training script for diffusion TRPO (cleaned up and modular)"""
...
from .training.agent import DiffusionTRPOAgent
...
def main(category: str = DEFAULT_CATEGORY):
    ...
    print(f"=== DIFFUSION TRPO TRAINING - {timestamp} ===")
